...
<body>
    ...
    <section class="optimization">
        <div class="container">
            ...
            <img src="img/bg/woman.png" alt="woman" class="optimization_img">
        </div>
    </section>
    <section class="finish">
        <div class="container">
            <h2 class="waiting_header finish_header">По окончании обучения Вы сможете!</h2>
            <div class="waiting_divider"></div>
            <div class="finish_wrapper">
                <div class="finish_item">
                    <div class="finish_round">
                        <img src="icons/finish/1.png" alt="fin_img_1" class="finish_icon">
                    </div>
                    <div class="finish_descr">Создать свой сайт или блог</div>
                </div>
                <div class="finish_item">
                    <div class="finish_round">
                        <img src="icons/finish/2.png" alt="fin_img_2" class="finish_icon">
                    </div>
                    <div class="finish_descr">Правильно его оптимизировать</div>
                </div>
                <div class="finish_item">
                    <div class="finish_round">
                        <img src="icons/finish/3.png" alt="fin_img_3" class="finish_icon">
                    </div>
                    <div class="finish_descr">Обеспечить ему медленный, но верный рост в ТОП</div>
                </div>
                <div class="finish_item">
                    <div class="finish_round">
                        <img src="icons/finish/4.png" alt="fin_img_4" class="finish_icon">
                    </div>
                    <div class="finish_descr">Достигнуть стабильного прироста посетителей</div>
                </div>
                <div class="finish_item">
                    <div class="finish_round">
                        <img src="icons/finish/5.png" alt="fin_img_5" class="finish_icon">
                    </div>
    ...
    <section class="present">
        <div class="container">
            <img src="icons/present.png" alt="pres_img" class="present_img">
            ...
            <button class="promo_btn present_present">Записаться на интенсив</button>
        </div>
    </section>
    <section class="fWebinar">
        <div class="container">
            <img src="img/first_webinar/first_web.png" alt="" class="fWebinar_img">
            <h1 class="fWebinar_title">Первый вебинар состоится:</h1>
            <h2 class="fWebinar_subtitle">10 сентября в 20:00 по Москве</h2>
            <div class="fWebinar_text">Успейте записаться, количество мест ограничено!</div>
        </div>
    </section>
    <footer class="footer">
        <div class="container">
